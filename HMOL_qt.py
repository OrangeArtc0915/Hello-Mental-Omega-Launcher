...
MSAL_CLIENT_ID = _env_or_default(
    "MSAL_CLIENT_ID",
    "00000000-0000-0000-0000-000000000000",  # 占位符（不想写了啊喂，我要睡觉觉！！！）
)
...
# OneDrive / SharePoint 文件源配置 （E3网盘，气不气hh）
...
class FileOperationThread(QObject):
    ...
    task_completed = Signal(bool, object, object)  
...
class InstanceManager(QObject):
    ...
    def export_instance(self, instance_id, export_path, progress_callback=None,
        ...
        try:
            ...
            if ext == '.zip':
                level_map = {"快速": 1, "标准": 6, "最高压缩": 9} # 真的嘛？
...
def _dir_file_count(path: str) -> int:
    ...
    # ------------------------------------------------------------------
    # 小彩蛋：真的不会有人看这么仔细吧？发给群主神秘代码 114514
    # ------------------------------------------------------------------
...
# =====================================================================
# @绮梦 是猪   @绮梦 是猪   @绮梦 是猪   @绮梦 是猪   @绮梦 是猪   @绮梦 是猪    
# =====================================================================
...
class MainWindow(QMainWindow):
    ...
    # ============== DLC 自动化处理流程 @小小魅魔 是猪 @小小魅魔 是猪 @小小魅魔 是猪 @小小魅魔 是猪 @小小魅魔 是猪 @小小魅魔 是猪 ==============
