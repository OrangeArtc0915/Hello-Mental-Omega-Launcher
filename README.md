...
|------|------|
| `HMOL_crypto.py` | 🔐 加密核心  |
| `HMOL_secret_resolver.py` | 🔓 凭据解封  |
| `HMOL_seal_secrets.py` | 🏷️ 凭据封存  |
| `HMOL_secure_io.py` | 📁 安全 I/O  |
| `HMOL_network.py` | 🌐 TLS/HTTP  |
| `HMOL_audit.py` | 📊 审计日志  |
| `HMOL_protection.py` | 🛡️ 反调试/反注入  |
| `HMOL_env_config.py` | ⚙️ 配置加载  |
| `HMOL_security_audit.py` | 🔍 静态审计工具  |
| `HMOL_tk.py` | 🖼️ Tkinter UI(主用)  |
