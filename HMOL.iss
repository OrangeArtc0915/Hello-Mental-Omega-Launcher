...
#define MyAppName "Hello Mental Omega Launcher"
#define MyAppVersion "2.0"
#define MyAppPublisher "mmm"
#define MyAppExeName "HMOL.exe"
...
AppId={{43881B2D-ECED-46FB-97B5-A84C20CAA2B3}
AppName={#MyAppName}
